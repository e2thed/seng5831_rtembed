...
volatile uint32_t G_red_period = 1000;
volatile uint32_t G_green_period = 1000;
volatile uint32_t G_yellow_period = 10;

volatile uint32_t G_release_red = 0;
